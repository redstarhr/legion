...
function createDashboardActionRows() {
    ...
    const row2 = new ActionRowBuilder()
        .addComponents(
            ...
            new ButtonBuilder().setCustomId('dash_open_cancelAcceptanceSelect').setLabel('受注取消').setStyle(ButtonStyle.Danger),
            new ButtonBuilder().setCustomId('dash_open_completeQuestSelect').setLabel('討伐').setStyle(ButtonStyle.Primary),
